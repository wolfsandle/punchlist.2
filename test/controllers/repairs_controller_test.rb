...
class RepairsControllerTest < ActionController::TestCase
  ...
  test "should create repair" do
    assert_difference('Repair.count') do
      post :create, repair: { description: @repair.description, name: @repair.name, room_id: @repair.room_id, user_id: @repair.user_id }
    end
  ...
  test "should update repair" do
    patch :update, id: @repair, repair: { description: @repair.description, name: @repair.name, room_id: @repair.room_id, user_id: @repair.user_id }
    assert_redirected_to repair_path(assigns(:repair))
  end
